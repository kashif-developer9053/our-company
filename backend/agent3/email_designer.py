...
def render_email_html(body: str, lead: dict, profile: dict) -> str:
    ...
    cta_block = (
        f'<tr><td style="padding:2px 34px 14px;">'
        f'<p style="margin:0;font-family:{BODY_FONT};font-size:15px;line-height:1.7;color:{MUTED};">'
        f'<a href="{_esc(cta_link)}" style="color:{GREEN};text-decoration:underline;font-weight:bold;">'
        f'Reply and I&rsquo;ll send you the details</a> &mdash; takes ten seconds.</p>'
        f'</td></tr>'
    )
