...
WRITE_SYSTEM = (
    ...
    "Hint that you know specifically what is wrong and can show them — that curiosity gap is what "
    "earns the reply.\n\n"
    "YOUR METHOD:\n"
    ...
    "4. Close with ONE easy question that offers to SHOW them what you found. Something like asking if "
    "they want you to send over the specifics. Low friction, no pressure, no hard meeting demand.\n\n"
    "HARD RULES:\n"
